<div class="hidden laptop:block w-full tablet:max-w-2xl laptop:max-w-4xl laptop-l:max-w-[1102px] mx-auto bg-white -mt-28 rounded-2xl">
   <div class="flex justify-between pr-4">
       <div class="flex">
           <div class="px-6 col-span-3 hover:bg-gray-200 py-3 pl-6 cursor-pointer transform duration-300 hover:rounded-2xl">
               <div class="w-[274px]  space-y-2"  id="container-location-destop">
           ...
           <div class="px-6 hover:bg-gray-200 py-3 cursor-pointer transform duration-300 hover:rounded-2xl">
