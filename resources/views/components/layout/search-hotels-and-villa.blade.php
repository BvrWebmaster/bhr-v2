   ...
   <div class="flex justify-between pr-4">
       ...
       <div class="col-span-2 flex items-center justify-center">
           <a href="{{ route('hotels-and-villa.index') }}" class="flex items-center justify-center">
               <div class="bg-[#FF5700] rounded-xl py-3 px-6 transform duration-300 active:scale-95">
    ...
    <script>
        $(document).ready(function () {
            $('.container-location').click(function () {
                $('#modal-searching').fadeIn('fast');
            });

            $('.container-start-date').click(function () {
                $('#modal-searching').fadeIn('fast');
            });

            $('.container-end-date').click(function () {
                $('#modal-searching').fadeIn('fast');
            });

            $('.container-guest').click(function () {
                $('#modal-searching').fadeIn('fast');
            });
        });
    </script>
