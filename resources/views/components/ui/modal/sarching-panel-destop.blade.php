<div id="modal-searching" class="hidden">
    <div class="overflow-y-auto overflow-x-hidden fixed top-0 z-50 flex justify-center items-center w-full tablet:inset-0 bg-black/50 backdrop-blur h-[100vh]">
        <div class="relative w-full bg-white max-w-md max-h-full transform duration-200 space-y-4">
            <div class="relative rounded-lg shadow py-2 px-4">
                <div class="flex items-center justify-between py-2 border-b rounded-t">
                    <button id="btn-modal-searching" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                ...
                <div class="w-full space-y-4 overflow-y-auto py-3">
                    ...
                    <div class="space-y-2">
                        <label for="container-locations-desktop" class="block text-sm font-medium text-gray-900">Select Location</label>
                        <select id="container-locations-desktop" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </select>
                    </div>
                    ...
                    <div  class="w-full flex items-center justify-between tablet:justify-start tablet:space-x-2">
                        <div class="relative w-full">
                            ...
                            <input id="start-date-desktop" name="start" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date start">
                        </div>
                        <div class="relative w-full">
                            <label class="block mb-2 text-sm font-medium text-gray-900">End date</label>
                            <input id="end-date-desktop" name="start" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date start">
                        </div>
                    </div>
