<div class="p-4 md:px-5 md:pt-2 md:pb-5">
    <form method="post" class="space-y-4">
        ...
        @method("post")
        <div>
            <label for="email-guest" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
            <input type="email" id="email-guest" name="email" placeholder="name@gmail.com" required
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div>
            <label for="password-guest" class="block mb-2 text-sm font-medium text-gray-900">Password</label>
